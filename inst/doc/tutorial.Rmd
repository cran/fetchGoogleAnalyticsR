...
## Analyzing Google Analytics marketing data 

Now we can analyze data from Google Analytics data. For instance, let's compare the two campaigns we have to see which one performed better the last 100 days. 
